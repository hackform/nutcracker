...
func Test_Error_Error(t *testing.T) {
	...
	assert.NotEqual("", ErrUnclosedBrace.Error(), "error should not be empty")
	...
	assert.NotEqual("", ErrInvalidCloseBrace.Error(), "error should not be empty")
	assert.NotEqual("", ErrInvalidVar.Error(), "error should not be empty")
